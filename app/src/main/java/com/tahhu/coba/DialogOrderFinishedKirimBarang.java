...
public class DialogOrderFinishedKirimBarang extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.dialog_order_finished_kirimbarang);
        ...
        btnback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(DialogOrderFinishedKirimBarang.this, MainActivity.class);
