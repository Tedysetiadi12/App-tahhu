...
public class DriverFoodSearchArrived extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_driver_food_search_arrived);
    ...
    private void showDriverArrivedDialog() {
        ...
        dialog.setContentView(R.layout.dialog_driver_food_arrived);
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(DriverFoodSearchArrived.this, DialogRatingDriverFood.class);
