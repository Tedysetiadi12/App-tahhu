...
public class DialogRatingDriverFood extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_rating_driver_food);
        ...
        giveRateButton.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(DialogRatingDriverFood.this, DialogRatingFood.class);
