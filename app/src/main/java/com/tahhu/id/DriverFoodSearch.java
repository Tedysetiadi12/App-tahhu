...
public class DriverFoodSearch extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_driver_food_search);
        ...
        slideToCancel.setOnSlideCompleteListener(new SlideToCancel.OnSlideCompleteListener() {
            ...
            public void onSlideComplete() {
                ...
                Intent intent = new Intent(DriverFoodSearch.this, CancelOrderActivity.class);
        ...
        new android.os.Handler().postDelayed(() -> {
            if (isSearching) {
                ...
                Intent intent = new Intent(DriverFoodSearch.this, DriverFoodSearchArrived.class);
                startActivity(intent);
                finish();
            }
        }, delayMillis);
